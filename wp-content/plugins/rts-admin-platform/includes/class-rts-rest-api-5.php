...
class RTS_REST_API_5 {
	...
	public static function register_routes() {
		...
		$r( '/email-campaigns/(?P<id>\d+)',                  'DELETE', 'delete_campaign', 'rts_send_bulk' );
		...
		$r( '/email-campaigns/(?P<id>\d+)/sent-recipients',  'GET', 'sent_recipients', 'rts_view' );
	...
	public static function delete_campaign( $q ){ $b = self::body( $q ); return self::out( RTS_Business_Logic_5::delete_campaign( (int) $q['id'], $b['deleted_by'] ?? null ) ); }
	...
	public static function sent_recipients( $q ){ return self::out( RTS_Business_Logic_5::sent_recipients( (int) $q['id'] ) ); }
