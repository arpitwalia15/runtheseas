...
- Accepts uploaded and imported files regardless of extension casing, like .JPG or .jpg
...
- Adds Advanced Reporting tools to the MCP interface for AI assistants
- Adds one-click FluentHub install on the MCP settings page when Fluent Forms Pro is active
...
= 6.2.9 (Date: August 1, 2026) =
- Maintenance update with minor improvements and compatibility fixes
