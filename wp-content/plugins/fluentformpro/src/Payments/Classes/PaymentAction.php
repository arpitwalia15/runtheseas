...
//        }
    ...
    private function insertOrderItems($items, $existing = false)
    {
        ...
        if ($verifiedIds) {
            // SECURITY (PRO-06): this prunes the CURRENT submission's stale order items, but
            // the delete was unscoped — whereNotIn('id', <this submission's ids>) removed every
            // other submission's order_items site-wide. It also fires on ordinary payment
            // retries, so it was a live data-loss bug too. Constrain the delete to this
            // submission.
