...
class OrderData
{
    ...
    public static function getTransactions($submissionId)
    {
        ...
        foreach ($transactions as $transaction) {
            $transaction->payment_note = PaymentHelper::safeUnserialize($transaction->payment_note);
	...
	public static function getSubscriptionsAndPaymentTotal($submission)
	{
		...
		foreach ($subscriptions as $subscription) {
			$subscription->original_plan = PaymentHelper::safeUnserialize($subscription->original_plan);
			$subscription->vendor_response = PaymentHelper::safeUnserialize($subscription->vendor_response);
