...
trait RTS_Registration_Ajax
{
    ...
    public function send_registration_confirmation($email, $data, $participant, $referral_link)
    {
        ...
        $message .= "<li style='padding: 8px 0; border-bottom: 1px solid #dee2e6;'>✅ <strong>Captain's Referral Race</strong> - Compete and win rewards</li>";
        $message .= "<li style='padding: 8px 0; border-bottom: 1px solid #dee2e6;'>✅ <strong>Captain's Miles</strong> - Earn miles for activities</li>";
