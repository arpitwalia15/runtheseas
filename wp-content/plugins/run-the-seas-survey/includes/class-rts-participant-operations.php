            ...
            <div style="overflow:auto;background:#fff;border:1px solid #dcdcde;">
                ...
                <?php foreach ($participants as $participant) : ?>
                    <tr>
                        ...
                        <td><?php echo esc_html(ucfirst($participant->captain_suite_status)); ?><br><small>Miles: <?php echo esc_html(number_format_i18n((int) $participant->captain_miles_balance)); ?></small></td>
